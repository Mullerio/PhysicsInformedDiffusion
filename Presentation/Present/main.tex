...
\begin{frame}{Experimental Setup}
    ...
    \begin{align*}
        ...
        -\nabla \cdot u(x) = f(x) \\
    \end{align*}
    where $K$ is the permeability field, $p$ the pressure field and $f$ a source term. They describe fluid flow through porus media e.g. materials with small holes like sponges.
\end{frame}
